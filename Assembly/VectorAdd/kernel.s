...
VectorAdd:
	.amd_kernel_code_t
		...
		kernel_code_prefetch_byte_size = 0
                // specify how many vgpr used: (max for this kernel is 4 * (granulated_workitem_vgpr_count + 1)
		granulated_workitem_vgpr_count = 1
                // specify how many sgpr used: (max for this kernel is 8 * (granulated_wavefront_sgpr_count + 1)
		...
		wavefront_sgpr_count = 0 // unused ??
		workitem_vgpr_count = 0  // unused ??
...
// Disassembly:
	...
	s_load_dword s9, s[4:5], 0x4                               // 000000001100: C0020102 00000004
        // get input a address
	s_load_dwordx2 s[0:1], s[6:7], 0x0                         // 000000001108: C0060003 00000000
        // get input b address
        s_load_dwordx2 s[2:3], s[6:7], 0x8
        // get output address
	s_load_dwordx2 s[4:5], s[6:7], 0x10                         // 000000001110: C0060083 00000008

        // wait for load input output address
        s_waitcnt lgkmcnt(0)

        // get work size x
	s_and_b32 s9, s9, 0xffff                                   // 000000001128: 8604FF04 0000FFFF
	s_mul_i32 s8, s8, s9                                       // 000000001130: 92080408

        // get global id
	v_add_u32_e32 v1, vcc, s8, v0                              // 000000001134: 32000008
        v_mov_b32_e32 v0, 0
	v_ashrrev_i64 v[0:1], 30, v[0:1]                           // 00000000113C: D2910000 0002029E
	...
	flat_load_dword v2, v[2:3]                                 // 000000001150: DC500000 02000002
        ...
        // get this work input address v[4:5]
        // by add input address and global_id * 4
        v_mov_b32_e32  v4, s3                                       // 000000001144: 7E060201
        v_add_u32_e32  v3, vcc, s2, v0                              // 000000001148: 32040000
        v_addc_u32_e32 v4, vcc, v4, v1, vcc                        // 00000000114C: 38060303
        flat_load_dword v3, v[3:4]                                 // 000000001150: DC500000 0200000
	...
	s_waitcnt vmcnt(0) lgkmcnt(0)                              // 000000001164: BF8C0070
        ...
        // by add input address and global_id * 4
        v_mov_b32_e32  v4, s5                                       // 000000001158: 7E060203
        v_add_u32_e32  v0, vcc, s4, v0                              // 00000000115C: 32000002
        v_addc_u32_e32 v1, vcc, v4, v1, vcc                        // 000000001160: 38020303
